      ...
      >
        ...
        <Card className="border-primary/20">
          <CardHeader className="text-center pb-8">
            <div className="w-20 h-16 rounded-2xl bg-primary/20 border border-primary flex items-center justify-center mx-auto mb-6 neon-glow">
              <span className="text-primary font-display font-bold text-3xl">NMR</span>
            </div>
